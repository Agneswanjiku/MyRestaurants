...
import com.moringaschool.myrestaurants.Adapter.MyRestaurantsArrayAdapter;
...
public class RestaurantsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<Bussiness> call = client.getRestaurants(location, "restaurants");

        call.enqueue(new Callback<Bussiness>() {
            @Override
